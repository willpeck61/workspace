...
<head>
	...
	<title>Guestlist Faces Monday</title>
	<link rel="stylesheet" type="text/css" href="./monday-faces.css" media="all" />
    ...
    if (mysqli_connect_errno($con))
{
	...
	$visitors = $_SESSION['views'];
   	mysqli_query($con,"INSERT INTO `monday-guestlist` (firstname, surname, postcode, mobilenumber, emailaddress, date) VALUES ('$firstname', '$surname', '$postcode', '$mobilenumber', '$emailaddress', '$date')");
	echo "<script type='text/javascript'>alert('Thanks " . $firstname . "! You have been added to the Q-jump list for Monday.')</script>";
...
<div id="monday-faces_r1_c1">
</div>
<div id="monday-faces_r2_c1">
</div>
<a href="www.faceswolverhampton.co.uk">
	<img src="monday-faces_r2_c5.jpg" id="monday-faces_r2_c5" alt="Faces Wolverhampton Home" />
	</a>
<div id="monday-faces_r2_c7">
</div>
<div id="monday-faces_r3_c1">
</div>
<img src="monday-faces_r3_c2.jpg" id="monday-faces_r3_c2" alt="" />
<div id="monday-faces_r3_c3">
</div>
<div id="monday-faces_r4_c5">
</div>
<div id="monday-faces_r5_c3">
</div>
<div id="monday-faces_r5_c6">
</div>
<div id="monday-faces_r6_c2">
</div>
<div id="monday-faces_r6_c4">
</div>
</body>
</html>

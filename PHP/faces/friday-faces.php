...
<head>
	...
	<title>Guestlist Faces Friday</title>
    ...
    if (mysqli_connect_errno($con))
{
	...
	$visitors = $_SESSION['views'];
   	mysqli_query($con,"INSERT INTO `friday-guestlist` (firstname, surname, postcode, mobilenumber, emailaddress, date) VALUES ('$firstname', '$surname', '$postcode', '$mobilenumber', '$emailaddress', '$date')");
	echo "<script type='text/javascript'>alert('Thanks " . $firstname . "! You have been added to the Q-jump list for Friday.')</script>";
...
<img src="images/kinky2.jpg" id="monday-faces_r3_c2" alt="" />

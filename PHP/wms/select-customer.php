...
include "alerts.php"; //ALERT!!

//Use Object to insert or update data to table.
...
//Get ALL Stored Data from any Table for Combo search boxes 
...
//Turn array in to a list of values - thought I would need to do this - DIDNT!!
...
//Customer Selected (or anything now actually) :: VARS MUST PARSE THROUGH JSON BEFORE JS CAN USE THEM!!

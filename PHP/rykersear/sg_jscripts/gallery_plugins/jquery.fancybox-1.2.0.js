...
;(function($) {
	...
	$.fn.fancybox = function(settings) {
		...
		function _start() {
			...
			if(typeof(opts.itemArray) != "object" && opts.itemArray.contructor != Array) { opts.itemArray = []; }
			opts.itemCurrent	= 0;
...
//			} else {
			...
			while ((opts.itemArray[ opts.itemCurrent ].href != elem.href) && (opts.itemCurrent > 0))
			{
				opts.itemCurrent--;
			}
			...
			if (opts.overlayShow) {
				...
				$("#fancy_overlay").css('background-color', opts.overlayColor);

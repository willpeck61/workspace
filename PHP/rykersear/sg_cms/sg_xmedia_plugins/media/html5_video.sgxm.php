<?php
 //html5 video Plugin
 //http://www.medialab.com/sitegrinder3/support/SG3_HelpJump.html?helpsym=html5_video_xmc
 //Video importer for HTML 5. MP4 for most browsers. WebM for Opera and Firefox
...
{
  echo \'--> \';
'); /*literal*/ fwrite($file, 'echo \'  <video id="video-\';');  /*expression*/ fwrite($file, 'echo $SG_DIVNAME;'); /*literal*/ fwrite($file, 'echo \'" \';');  /*expression*/ fwrite($file, 'echo \'' . SHOW_CONTROLLER(PLUGIN_OPTION_VAL($OPTIONSDOM, "show controller")) . '\';');  /*literal*/ fwrite($file, 'echo \' \';');  /*expression*/ fwrite($file, 'echo \'' . AUTOPLAY(PLUGIN_OPTION_VAL($OPTIONSDOM, "autoplay")) . '\';');  /*literal*/ fwrite($file, 'echo \' \';');  /*expression*/ fwrite($file, 'echo \'' . LOOP(PLUGIN_OPTION_VAL($OPTIONSDOM, "loop")) . '\';');  /*literal*/ fwrite($file, 'echo \' preload="auto" width="\';');  /*expression*/ fwrite($file, 'echo $SG_DIVWIDTH;'); /*literal*/ fwrite($file, 'echo \'" height="\';');  /*expression*/ fwrite($file, 'echo $SG_DIVHEIGHT;'); /*literal*/ fwrite($file, 'echo \'" \';');  /*expression*/$p = 'PLUGIN_PATH("' . PLUGIN_OPTION_VAL($OPTIONSDOM, "poster_frame", $ENVIRODOM) . '", 0)';
 fwrite($file, 'echo \'' . POSTER_FRAME(' . $p . ') . '\';');  /*literal*/ fwrite($file, 'echo \'>
...
');if( BOOL(PLUGIN_OPTION_VAL($OPTIONSDOM, "autoplay")) )
{
 ...
 <script>document.addEventListener("\';');  /*expression*/ fwrite($file, 'echo $SG_DIVNAME;'); /*literal*/ fwrite($file, 'echo \'" + ":slideenter", function(){ document.getElementById("video-\';');  /*expression*/ fwrite($file, 'echo $SG_DIVNAME;'); /*literal*/ fwrite($file, 'echo \'").play();}); document.addEventListener("\';');  /*expression*/ fwrite($file, 'echo $SG_DIVNAME;'); /*literal*/ fwrite($file, 'echo \'" + ":slideleave", function(){ document.getElementById("video-\';');  /*expression*/ fwrite($file, 'echo $SG_DIVNAME;'); /*literal*/ fwrite($file, 'echo \'").pause();});</script>\';'); }  fwrite($file, ' echo \' <!--\';
}');  fwrite($file, '?>');
  fclose($file);
 }
...
// main entry
 ...
 {
    echo '<plugin name="html5 video" url="http://www.medialab.com/sitegrinder3/support/SG3_HelpJump.html?helpsym=html5_video_xmc" type="media/html5_video.sgxm.php" >
 <info>Video importer for HTML 5. MP4 for most browsers. WebM for Opera and Firefox</info>

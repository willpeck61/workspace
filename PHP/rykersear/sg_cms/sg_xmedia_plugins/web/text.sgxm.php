<?php
 //text Plugin
 //http://www.medialab.com/sitegrinder3/support/SG3_HelpJump.html?helpsym=text_xmc
...
{
  echo \'--> \';
'); /*literal*/ fwrite($file, 'echo \'\';');  /*expression*/ fwrite($file, 'echo \'' . PLUGIN_OPTION_VAL($OPTIONSDOM, "text") . '\';');  /*literal*/ fwrite($file, 'echo \'\';');   fwrite($file, ' echo \' <!--\';
...
// main entry
 ...
 {
    echo '<plugin name="text" url="http://www.medialab.com/sitegrinder3/support/SG3_HelpJump.html?helpsym=text_xmc" type="web/text.sgxm.php" >
 <info>place some text on the page</info>
<option name="text" type="text" value="" /></plugin>';
 }

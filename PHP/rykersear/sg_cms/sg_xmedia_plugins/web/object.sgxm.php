<?php
 //object Plugin
 //http://www.medialab.com/sitegrinder3/support/SG3_HelpJump.html?helpsym=object_xmc
 //Import the content onto your page using the  &amp;lt;object&amp;gt; tag.
...
{
  /*literal*/ fwrite($file, 'echo \'<object type="text/html" data="\';');  /*expression*/$p = '\' . PLUGIN_PATH("' . PLUGIN_OPTION_VAL($OPTIONSDOM, "url", $ENVIRODOM) . '", 0) . \'';
 fwrite($file, 'echo \'' . $p . '\';');  /*literal*/ fwrite($file, 'echo \'" width="\';');  /*expression*/ fwrite($file, 'echo $SG_DIVWIDTH;'); /*literal*/ fwrite($file, 'echo \'" height="\';');  /*expression*/ fwrite($file, 'echo \'' . PLUGIN_OPTION_VAL($OPTIONSDOM, "override height") . '\';');  /*literal*/ fwrite($file, 'echo \'"/>\';'); }
else
{
  /*literal*/ fwrite($file, 'echo \'<object type="text/html" data="\';');  /*expression*/$p = '\' . PLUGIN_PATH("' . PLUGIN_OPTION_VAL($OPTIONSDOM, "url", $ENVIRODOM) . '", 0) . \'';
 fwrite($file, 'echo \'' . $p . '\';');  /*literal*/ fwrite($file, 'echo \'" width="\';');  /*expression*/ fwrite($file, 'echo $SG_DIVWIDTH;'); /*literal*/ fwrite($file, 'echo \'" height="\';');  /*expression*/ fwrite($file, 'echo $SG_DIVHEIGHT;'); /*literal*/ fwrite($file, 'echo \'"/>\';'); }  fwrite($file, ' echo \' <!--\';
...
');if( BOOL(REGEX_MATCH("(override)", PLUGIN_OPTION_VAL($OPTIONSDOM, "height"))) )
{
  /*literal*/ fwrite($file, 'echo \'<style type="text/css" media="screen,print,projection">#\';');  /*expression*/ fwrite($file, 'echo $SG_DIVNAME;'); /*literal*/ fwrite($file, 'echo \'{ height:\';');  /*expression*/ fwrite($file, 'echo \'' . PLUGIN_OPTION_VAL($OPTIONSDOM, "override height") . '\';');  /*literal*/ fwrite($file, 'echo \'px;}</style>\';'); }
else
{
...
// main entry
 ...
 {
    echo '<plugin name="object" url="http://www.medialab.com/sitegrinder3/support/SG3_HelpJump.html?helpsym=object_xmc" type="web/object.sgxm.php" >
 <info>Import the content onto your page using the  &amp;lt;object&amp;gt; tag.</info>

...
{
return REGEX_REMOVE("<style[^>]*.*?</style>", REGEX_REPLACE_LAMBDA($ENVIRO, "\"(pubimage?[^\"]*)\"", REGEX_REPLACE_LAMBDA($ENVIRO, "href=\"#bookmark=([^\"]*)", REGEX_REMOVE(" id=[^ ^>]*", REGEX_REMOVE(" id=\"[^\"]*\"", REGEX_MATCH("<div id=\"contents\">(.*)</div>\\s*<div id=\"footer\">", FETCH_URL($URL, "body", $ENVIRO)))), 0, "remap_alt_bookmark"), 0, "remap_alt_link"));
 }
}
...
// main entry
 ...
 {
    echo '<plugin name="google doc no style" url="http://www.medialab.com/sitegrinder3/support/SG3_HelpJump.html?helpsym=google_doc_xmc" type="web/google_doc_no_style.sgxm.php" >

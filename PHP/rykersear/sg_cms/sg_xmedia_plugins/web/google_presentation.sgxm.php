<?php
 //google presentation Plugin
 //http://www.medialab.com/sitegrinder3/support/SG3_HelpJump.html?helpsym=google_presentation_xmc
 //Place Google Presentation (aka Google PowerPoint) onto your page.
...
{
  echo \'--> \';
'); /*literal*/ fwrite($file, 'echo \'<iframe src="http://docs.google.com/EmbedSlideshow?docid=\';');  /*expression*/ fwrite($file, 'echo \'' . REGEX_MATCH("id=(.*)", PLUGIN_OPTION_VAL($OPTIONSDOM, "url")) . '\';');  /*literal*/ fwrite($file, 'echo \'&amp;browserok=true" width="\';');  /*expression*/ fwrite($file, 'echo $SG_DIVWIDTH;'); /*literal*/ fwrite($file, 'echo \'" height="\';');  /*expression*/ fwrite($file, 'echo $SG_DIVHEIGHT;'); /*literal*/ fwrite($file, 'echo \'" frameborder="0"></iframe>\';');   fwrite($file, ' echo \' <!--\';
...
// main entry
 ...
 {
    echo '<plugin name="google presentation" url="http://www.medialab.com/sitegrinder3/support/SG3_HelpJump.html?helpsym=google_presentation_xmc" type="web/google_presentation.sgxm.php" >
 <info>Place Google Presentation (aka Google PowerPoint) onto your page.</info>

<option name="url" type="online-url" value="" extensions="*" /></plugin>';
 }

<?php
 //wazala store Plugin
 //http://www.medialab.com/sitegrinder3/support/SG3_HelpJump.html?helpsym=wazala_xmc
 //embed the code for a Wazala store
...
');  fwrite($file, 'echo \'<!-- \';
  ...
  echo \'--> \';
'); /*literal*/ fwrite($file, 'echo \'\';');  /*expression*/ fwrite($file, 'echo \'' . PLUGIN_OPTION_VAL($OPTIONSDOM, "script code") . '\';');  /*literal*/ fwrite($file, 'echo \'\';');   fwrite($file, ' echo \' <!--\';
}');  fwrite($file, '?>');
  fclose($file);
 }
...
// main entry
 ...
 {
    echo '<plugin name="wazala store" url="http://www.medialab.com/sitegrinder3/support/SG3_HelpJump.html?helpsym=wazala_xmc" type="expert/wazala.sgxm.php" >
 <info>embed the code for a Wazala store</info>

<option name="script code" type="html" value="" />
</plugin>';
 }

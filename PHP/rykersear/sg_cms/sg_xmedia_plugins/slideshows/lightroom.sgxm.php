<?php
 //lightroom Plugin
 //http://www.medialab.com/sitegrinder3/support/SG3_HelpJump.html?helpsym=lightroom_xmc
 //Use this importer to import the  &lt;b&gt;index.html&lt;/b&gt; file created when Lightroom outputs a gallery.
...
'); /*literal*/ fwrite($file, 'echo \'<iframe src="\';');  /*expression*/$p = '\' . PLUGIN_PATH("' . PLUGIN_OPTION_VAL($OPTIONSDOM, "url", $ENVIRODOM) . '", 0) . \'';
 fwrite($file, 'echo \'' . $p . '\';');  /*literal*/ fwrite($file, 'echo \'" width="\';');  /*expression*/ fwrite($file, 'echo $SG_DIVWIDTH;'); /*literal*/ fwrite($file, 'echo \'" height="\';');  /*expression*/ fwrite($file, 'echo $SG_DIVHEIGHT;'); /*literal*/ fwrite($file, 'echo \'" frameborder="0"></iframe>\';');   fwrite($file, ' echo \' <!--\';
...
// main entry
 ...
 {
    echo '<plugin name="lightroom" url="http://www.medialab.com/sitegrinder3/support/SG3_HelpJump.html?helpsym=lightroom_xmc" type="slideshows/lightroom.sgxm.php" >
 <info>Use this importer to import the  &lt;b&gt;index.html&lt;/b&gt; file created when Lightroom outputs a gallery.</info>
